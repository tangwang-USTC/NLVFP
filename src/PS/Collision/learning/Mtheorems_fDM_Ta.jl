...
# M̂a[1], the M-function of the single spice at time step `tₖ` when `ma = mb`
function Mhcsj_fM(na::AbstractVector{T},Ta::AbstractVector{T},
    j::Int64,Mhcj::AbstractVector{T}) where{T}
...
function Mhcsj_fM!(Mhcsjt::AbstractVector{T},ma::AbstractVector{T},na::AbstractVector{T},
    Ta::AbstractArray{T,N},Nt::Int64,j::Int64,Mhcj::AbstractArray{T,N}) where{N,T}
